...
entity GenerateProof_fifo_w128_d2_S_x1 is 
    generic (
...
architecture rtl of GenerateProof_fifo_w128_d2_S_x1 is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component GenerateProof_fifo_w128_d2_S_x1_ShiftReg is
    generic (
        DATA_WIDTH : integer := 128;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_GenerateProof_fifo_w128_d2_S_x1_ShiftReg : GenerateProof_fifo_w128_d2_S_x1_ShiftReg
    generic map (
...
entity GenerateProof_fifo_w128_d2_S_x1_ShiftReg is
    generic (
        DATA_WIDTH : integer := 128;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end GenerateProof_fifo_w128_d2_S_x1_ShiftReg;

architecture rtl of GenerateProof_fifo_w128_d2_S_x1_ShiftReg is
