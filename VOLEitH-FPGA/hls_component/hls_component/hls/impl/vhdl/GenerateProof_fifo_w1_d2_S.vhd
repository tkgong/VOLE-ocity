...
entity GenerateProof_fifo_w1_d2_S is 
    generic (
...
architecture rtl of GenerateProof_fifo_w1_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component GenerateProof_fifo_w1_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_GenerateProof_fifo_w1_d2_S_ShiftReg : GenerateProof_fifo_w1_d2_S_ShiftReg
    generic map (
...
entity GenerateProof_fifo_w1_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end GenerateProof_fifo_w1_d2_S_ShiftReg;

architecture rtl of GenerateProof_fifo_w1_d2_S_ShiftReg is
