...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_a_strm \
    op interface \
    ports { a_strm_dout { I 256 vector } a_strm_empty_n { I 1 bit } a_strm_read { O 1 bit } a_strm_num_data_valid { I 3 vector } a_strm_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ch2_strm_dout { I 128 vector } ch2_strm_empty_n { I 1 bit } ch2_strm_read { O 1 bit } ch2_strm_num_data_valid { I 3 vector } ch2_strm_fifo_cap { I 3 vector } } \
} "
}
