...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename sd \
    op interface \
    ports { sd_address0 { O 2 vector } sd_ce0 { O 1 bit } sd_we0 { O 1 bit } sd_d0 { O 128 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'sd'"
}
}
