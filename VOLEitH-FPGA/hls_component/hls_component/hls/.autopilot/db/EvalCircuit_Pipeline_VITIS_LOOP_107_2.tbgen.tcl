set moduleName EvalCircuit_Pipeline_VITIS_LOOP_107_2
set isTopModule 0
...
set cdfgNum 41
set C_modelName {EvalCircuit_Pipeline_VITIS_LOOP_107_2}
...
dict set ap_memory_interface_dict extended_witness { MEM_WIDTH 1 MEM_SIZE 386045 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
...
set C_modelArgList {
	...
	{ extended_witness int 1 regular {array 386045 { 2 1 3 3 3 3 3 3 3 3 3 3 3 3 3 3 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "d_strm", "interface" : "axis", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "extended_witness", "interface" : "memory", "bitwidth" : 1, "direction" : "READWRITE"} , 
...
set portList { 
	...
	{ d_strm_TDATA sc_out sc_lv 8 signal 0 } 
	{ d_strm_TVALID sc_out sc_logic 1 outvld 0 } 
	{ d_strm_TREADY sc_in sc_logic 1 outacc 0 } 
	{ d_strm_cp_din sc_out sc_lv 1 signal 1 } 
	{ d_strm_cp_full_n sc_in sc_logic 1 signal 1 } 
	{ d_strm_cp_write sc_out sc_logic 1 signal 1 } 
	{ d_strm_cp_num_data_valid sc_in sc_lv 3 signal 1 } 
	{ d_strm_cp_fifo_cap sc_in sc_lv 3 signal 1 } 
	...
	{ a0_strm_din sc_out sc_lv 256 signal 4 } 
	{ a0_strm_full_n sc_in sc_logic 1 signal 4 } 
	{ a0_strm_write sc_out sc_logic 1 signal 4 } 
	{ a0_strm_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ a0_strm_fifo_cap sc_in sc_lv 3 signal 4 } 
	{ a1_strm_din sc_out sc_lv 128 signal 5 } 
	{ a1_strm_full_n sc_in sc_logic 1 signal 5 } 
	{ a1_strm_write sc_out sc_logic 1 signal 5 } 
	{ a1_strm_num_data_valid sc_in sc_lv 3 signal 5 } 
	{ a1_strm_fifo_cap sc_in sc_lv 3 signal 5 } 
	{ circuit_TDATA sc_in sc_lv 128 signal 6 } 
	{ circuit_TVALID sc_in sc_logic 1 invld 6 } 
	{ circuit_TREADY sc_out sc_logic 1 inacc 6 } 
	{ extended_witness_address0 sc_out sc_lv 19 signal 7 } 
	{ extended_witness_ce0 sc_out sc_logic 1 signal 7 } 
	{ extended_witness_we0 sc_out sc_logic 1 signal 7 } 
	{ extended_witness_d0 sc_out sc_lv 1 signal 7 } 
	{ extended_witness_q0 sc_in sc_lv 1 signal 7 } 
	{ extended_witness_address1 sc_out sc_lv 19 signal 7 } 
	{ extended_witness_ce1 sc_out sc_logic 1 signal 7 } 
	{ extended_witness_q1 sc_in sc_lv 1 signal 7 } 
	{ u_0_address0 sc_out sc_lv 18 signal 8 } 
	{ u_0_ce0 sc_out sc_logic 1 signal 8 } 
	{ u_0_q0 sc_in sc_lv 1 signal 8 } 
	{ u_0_address1 sc_out sc_lv 18 signal 8 } 
	{ u_0_ce1 sc_out sc_logic 1 signal 8 } 
	{ u_0_we1 sc_out sc_logic 1 signal 8 } 
	{ u_0_d1 sc_out sc_lv 1 signal 8 } 
	{ u_1_address0 sc_out sc_lv 18 signal 9 } 
	{ u_1_ce0 sc_out sc_logic 1 signal 9 } 
	{ u_1_q0 sc_in sc_lv 1 signal 9 } 
	{ u_1_address1 sc_out sc_lv 18 signal 9 } 
	{ u_1_ce1 sc_out sc_logic 1 signal 9 } 
	{ u_1_we1 sc_out sc_logic 1 signal 9 } 
	{ u_1_d1 sc_out sc_lv 1 signal 9 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "extended_witness_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "extended_witness", "role": "q0" }} , 
 	{ "name": "extended_witness_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "extended_witness", "role": "address1" }} , 
 	{ "name": "extended_witness_ce1", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "extended_witness", "role": "ce1" }} , 
 	{ "name": "extended_witness_q1", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "extended_witness", "role": "q1" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "576267", "Max" : "576267"}
	, {"Name" : "Interval", "Min" : "576267", "Max" : "576267"}
]}
...
set Spec2ImplPortList { 
	...
	extended_witness { ap_memory {  { extended_witness_address0 mem_address 1 19 }  { extended_witness_ce0 mem_ce 1 1 }  { extended_witness_we0 mem_we 1 1 }  { extended_witness_d0 mem_din 1 1 }  { extended_witness_q0 mem_dout 0 1 }  { extended_witness_address1 MemPortADDR2 1 19 }  { extended_witness_ce1 MemPortCE2 1 1 }  { extended_witness_q1 MemPortDOUT2 0 1 } } }
