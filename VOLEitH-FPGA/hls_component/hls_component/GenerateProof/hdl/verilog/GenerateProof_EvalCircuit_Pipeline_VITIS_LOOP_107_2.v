...
reg   [0:0] tmp_677_reg_664;
reg   [18:0] extended_witness_addr_1_reg_670;
reg   [0:0] tmp_678_reg_675;
...
reg   [17:0] i_13_fu_106;
wire   [17:0] i_22_fu_369_p2;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001_grp1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        ...
        tmp_677_reg_664 <= circuit_TDATA[128'd64];
        tmp_678_reg_675 <= circuit_TDATA[128'd96];
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_678_reg_675 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (gate_is_and_reg_637 == 1'd0))) begin
        V_0_we1_local = 1'b1;
    end else begin
        V_0_we1_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_678_reg_675 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (gate_is_and_reg_637 == 1'd0))) begin
        V_1_we1_local = 1'b1;
    end else begin
        V_1_we1_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_11001_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_678_reg_675 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage1) & (gate_is_and_reg_637 == 1'd0))) begin
        u_0_we1_local = 1'b1;
    end else begin
        u_0_we1_local = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage1_11001_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (tmp_678_reg_675 == 1'd1) & (1'b1 == ap_CS_fsm_pp0_stage1) & (gate_is_and_reg_637 == 1'd0))) begin
        u_1_we1_local = 1'b1;
    end else begin
        u_1_we1_local = 1'b0;
    end
...
assign grp_gf128_clmul_fu_339_b = ((tmp_677_reg_664[0:0] == 1'b1) ? V_1_load_1_reg_774 : V_0_load_1_reg_769);

assign i_22_fu_369_p2 = (ap_sig_allocacmp_i + 18'd1);

assign icmp_ln107_fu_363_p2 = ((ap_sig_allocacmp_i == 18'd135073) ? 1'b1 : 1'b0);

assign lshr_ln124_s_fu_452_p4 = {{circuit_TDATA[82:65]}};

assign lshr_ln_fu_421_p4 = {{circuit_TDATA[50:33]}};

assign select_ln115_fu_563_p3 = ((tmp_678_reg_675[0:0] == 1'b1) ? u_1_load_reg_799 : u_0_load_reg_794);

assign select_ln119_1_fu_550_p3 = ((tmp_677_reg_664[0:0] == 1'b1) ? V_1_load_1_reg_774 : V_0_load_1_reg_769);
...
assign select_ln120_fu_605_p3 = ((tmp_678_reg_675[0:0] == 1'b1) ? reg_350 : reg_345);

assign select_ln125_fu_535_p3 = ((tmp_reg_646[0:0] == 1'b1) ? u_1_q0 : u_0_q0);

assign select_ln126_1_fu_515_p3 = ((tmp_677_reg_664[0:0] == 1'b1) ? V_1_q0 : V_0_q0);
