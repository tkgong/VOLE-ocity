...
reg    d_strm_cp_blk_n;
reg   [9:0] i_23_reg_207;
reg    ap_block_pp0_stage0_11001;
wire   [63:0] zext_ln100_1_fu_157_p1;
wire   [63:0] zext_ln100_fu_168_p1;
reg   [9:0] i_fu_64;
wire   [9:0] add_ln100_fu_141_p2;
wire    ap_loop_init;
reg   [9:0] ap_sig_allocacmp_i_23;
...
assign add_ln100_fu_141_p2 = (ap_sig_allocacmp_i_23 + 10'd1);
...
assign icmp_ln100_fu_135_p2 = ((ap_sig_allocacmp_i_23 == 10'd769) ? 1'b1 : 1'b0);

assign lshr_ln_fu_147_p4 = {{ap_sig_allocacmp_i_23[9:1]}};

assign select_ln103_fu_180_p3 = ((trunc_ln100_fu_172_p1[0:0] == 1'b1) ? u_1_q0 : u_0_q0);

assign trunc_ln100_fu_172_p1 = i_23_reg_207[0:0];
...
assign zext_ln100_fu_168_p1 = i_23_reg_207;
