...
#pragma HLS STREAM variable=endDigestStrm depth=2
 ...
 endMsgLenStrm.write(false);
    msgStrm.write(x.range(63, 0));
    msgStrm.write(x.range(127, 64));
...
#pragma HLS LOOP_TRIPCOUNT min=0 max=2 avg=0
 if(endMsgLenStrm.empty()) break;
    ...
    seed = digest.range(255, 128);
    com = digest.range(127, 0);
}
...
#pragma HLS STREAM variable=endDigestStrm depth=2
 ...
 VITIS_LOOP_66_1: for (int t = 0; t< 64; t++){
#pragma HLS PIPELINE OFF
 endMsgLenStrm.write(false);
...
#pragma HLS STREAM variable=endDigestStrm depth=2
 const int N = 1<<2;
    ...
    VITIS_LOOP_105_1: for(int i = 0; i < 64; i++){
