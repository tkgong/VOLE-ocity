...
__attribute__((sdx_kernel("GenerateProof", 0))) void GenerateProof(
...
#line 1 "directive"
#pragma HLSDIRECTIVE TOP name=GenerateProof
# 14 "endtoend.cpp"
...
#pragma HLS BIND_STORAGE variable=V type=ram_2p impl=URAM
 hls::stream<ap_uint<128>> path_strm;
    ...
    ap_uint<128> a0_tilde;
    ap_uint<128> a1_tilde;
    INPUT_STREAM: for(int i = 0; i < 128; i++){
#pragma HLS PIPELINE II=1
 root[i] = root_strm.read();
    ...
    TRANSFER_STREAM: for(int i = 0; i < 64*(2 +2); i++){
