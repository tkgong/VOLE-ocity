...
reg   [0:0] icmp_ln73_reg_458;
reg   [127:0] ch1_val_read_reg_403;
reg    ap_block_state1;
wire   [0:0] icmp_ln70_fu_246_p2;
reg   [0:0] icmp_ln70_reg_448;
reg    ap_block_state3_pp0_stage0_iter1_grp1;
reg   [0:0] icmp_ln70_1_reg_462;
reg   [0:0] icmp_ln70_1_reg_462_pp0_iter1_reg;
reg    ap_block_state4_pp0_stage0_iter2_grp1;
reg    ap_enable_reg_pp0_iter2;
reg    ap_block_pp0_stage0_11001;
wire   [5:0] trunc_ln70_fu_286_p1;
reg   [5:0] trunc_ln70_reg_453;
wire   [0:0] icmp_ln73_fu_296_p2;
wire   [0:0] icmp_ln70_1_fu_308_p2;
reg   [63:0] p_0_reg_466;
...
wire   [0:0] icmp_ln67_fu_228_p2;
reg    ap_condition_pp0_exit_iter0_state2;
wire    grp_shake_extensible_fu_193_ap_start;
wire    grp_shake_extensible_fu_193_ap_done;
wire    grp_shake_extensible_fu_193_ap_idle;
wire    grp_shake_extensible_fu_193_ap_ready;
wire    grp_shake_extensible_fu_193_msgStrm_read;
wire    grp_shake_extensible_fu_193_msgLenStrm_read;
wire    grp_shake_extensible_fu_193_endMsgLenStrm_read;
wire    grp_shake_extensible_fu_193_outLenStrm_read;
wire    grp_shake_extensible_fu_193_endOutLenStrm_read;
wire   [127:0] grp_shake_extensible_fu_193_ch2_strm_din;
wire    grp_shake_extensible_fu_193_ch2_strm_write;
wire   [0:0] grp_shake_extensible_fu_193_endDigestStrm_internal_din;
wire    grp_shake_extensible_fu_193_endDigestStrm_internal_write;
reg    grp_shake_extensible_fu_193_ap_start_reg;
...
reg   [63:0] word_fu_100;
wire   [63:0] select_ln68_1_fu_332_p3;
wire   [63:0] word_1_fu_344_p4;
reg    ap_block_pp0_stage0_11001_grp1;
reg   [6:0] j_fu_104;
wire   [6:0] j_1_fu_302_p2;
wire    ap_block_pp0_stage0;
reg   [9:0] i_03_fu_108;
wire   [9:0] select_ln67_fu_266_p3;
reg   [15:0] indvar_flatten_fu_112;
wire   [15:0] add_ln67_fu_234_p2;
reg    ap_block_pp0_stage0_01001_grp1;
wire   [63:0] trunc_ln81_fu_362_p1;
...
wire   [9:0] add_ln67_1_fu_260_p2;
wire   [6:0] select_ln68_fu_252_p3;
wire   [15:0] mul_fu_274_p3;
wire   [15:0] zext_ln70_fu_282_p1;
wire   [15:0] bit_idx_fu_290_p2;
wire   [63:0] word_1_fu_344_p1;
reg   [6:0] ap_NS_fsm;
...
#0 grp_shake_extensible_fu_193_ap_start_reg = 1'b0;
#0 word_fu_100 = 64'd0;
#0 j_fu_104 = 7'd0;
#0 i_03_fu_108 = 10'd0;
#0 indvar_flatten_fu_112 = 16'd0;
end

GenerateProof_shake_extensible grp_shake_extensible_fu_193(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
GenerateProof_bitset_64ns_64ns_6ns_1ns_64_1_1 #(
    .DATAWIDTH( 64 ),
    .ADDRWIDTH( 6 ))
bitset_64ns_64ns_6ns_1ns_64_1_1_U1903(
...
GenerateProof_fifo_w64_d2_S_x msgStrm_fifo_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
GenerateProof_fifo_w128_d2_S_x2 msgLenStrm_fifo_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
GenerateProof_fifo_w128_d2_S_x2 outLenStrm_fifo_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        grp_shake_extensible_fu_193_ap_start_reg <= 1'b0;
    end else begin
        if ((1'b1 == ap_CS_fsm_state7)) begin
            grp_shake_extensible_fu_193_ap_start_reg <= 1'b1;
        end else if ((grp_shake_extensible_fu_193_ap_ready == 1'b1)) begin
            grp_shake_extensible_fu_193_ap_start_reg <= 1'b0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        i_03_fu_108 <= 10'd0;
    end else if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln67_fu_228_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state1) & (1'b1 == ap_CS_fsm_state1))) begin
        word_fu_100 <= 64'd0;
    end else if (((icmp_ln73_reg_458 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        word_fu_100 <= word_1_fu_344_p4;
    end else if (((icmp_ln73_reg_458 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_state5) & (1'b1 == ap_CS_fsm_state5))) begin
        p_0_reg_466 <= {{ch1_val_read_reg_403[127:64]}};
    end
end
...
always @ (*) begin
    if ((grp_shake_extensible_fu_193_ap_done == 1'b0)) begin
...
always @ (*) begin
    if ((icmp_ln67_fu_228_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln73_reg_458 == 1'd1) & (1'b0 == ap_block_pp0_stage0_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((icmp_ln73_reg_458 == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001_grp1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        d_strm_cp_read = 1'b1;
    end else begin
        d_strm_cp_read = 1'b0;
    end
...
always @ (*) begin
    ...
    end else if (((ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln70_1_reg_462_pp0_iter1_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_01001_grp1))) begin
...
always @ (*) begin
    if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln70_1_reg_462_pp0_iter1_reg == 1'd1) & (1'b0 == ap_block_pp0_stage0_11001_grp1)) | ((1'b0 == ap_block_state6) & (1'b1 == ap_CS_fsm_state6)) | ((1'b0 == ap_block_state5) & (1'b1 == ap_CS_fsm_state5)))) begin
        msgStrm_write = 1'b1;
    end else begin
        msgStrm_write = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (icmp_ln67_fu_228_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (icmp_ln67_fu_228_p2 == 1'd1) & (ap_enable_reg_pp0_iter0 == 1'b1)))) begin
        ...
        ap_ST_fsm_state8 : begin
            if (((1'b1 == ap_CS_fsm_state8) & (grp_shake_extensible_fu_193_ap_done == 1'b1))) begin
...
assign add_ln67_1_fu_260_p2 = (i_03_fu_108 + 10'd1);

assign add_ln67_fu_234_p2 = (indvar_flatten_fu_112 + 16'd1);
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1_grp1 = ((icmp_ln73_reg_458 == 1'd1) & (d_strm_cp_empty_n == 1'b0));
end

always @ (*) begin
    ap_block_state4_pp0_stage0_iter2_grp1 = ((icmp_ln70_1_reg_462_pp0_iter1_reg == 1'd1) & (msgStrm_full_n == 1'b0));
end
...
assign bit_idx_fu_290_p2 = (mul_fu_274_p3 + zext_ln70_fu_282_p1);

assign ch2_strm_din = grp_shake_extensible_fu_193_ch2_strm_din;

assign ch2_strm_write = grp_shake_extensible_fu_193_ch2_strm_write;

assign grp_shake_extensible_fu_193_ap_start = grp_shake_extensible_fu_193_ap_start_reg;

assign icmp_ln67_fu_228_p2 = ((indvar_flatten_fu_112 == 16'd40064) ? 1'b1 : 1'b0);

assign icmp_ln70_1_fu_308_p2 = ((j_1_fu_302_p2 == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln70_fu_246_p2 = ((j_fu_104 == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln73_fu_296_p2 = ((bit_idx_fu_290_p2 < 16'd40001) ? 1'b1 : 1'b0);

assign j_1_fu_302_p2 = (select_ln68_fu_252_p3 + 7'd1);

assign mul_fu_274_p3 = {{select_ln67_fu_266_p3}, {6'd0}};

assign select_ln67_fu_266_p3 = ((icmp_ln70_fu_246_p2[0:0] == 1'b1) ? add_ln67_1_fu_260_p2 : i_03_fu_108);

assign select_ln68_1_fu_332_p3 = ((icmp_ln70_reg_448[0:0] == 1'b1) ? 64'd0 : word_fu_100);

assign select_ln68_fu_252_p3 = ((icmp_ln70_fu_246_p2[0:0] == 1'b1) ? 7'd0 : j_fu_104);

assign trunc_ln70_fu_286_p1 = select_ln68_fu_252_p3[5:0];

assign trunc_ln81_fu_362_p1 = ch1_val_read_reg_403[63:0];

assign word_1_fu_344_p1 = ((icmp_ln70_reg_448[0:0] == 1'b1) ? 64'd0 : word_fu_100);

assign zext_ln70_fu_282_p1 = select_ln68_fu_252_p3;
