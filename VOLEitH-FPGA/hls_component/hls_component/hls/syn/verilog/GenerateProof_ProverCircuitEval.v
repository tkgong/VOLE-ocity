...
wire   [127:0] aggregate_coef_U0_proof_strm_TDATA;
wire    aggregate_coef_U0_proof_strm_TVALID;
...
GenerateProof_fifo_w128_d2_S_x3 a1_strm_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
GenerateProof_fifo_w128_d2_S_x3 ch2_strm_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
assign proof_strm_TDATA = aggregate_coef_U0_proof_strm_TDATA;

assign proof_strm_TVALID = aggregate_coef_U0_proof_strm_TVALID;
