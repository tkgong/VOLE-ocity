...
wire   [127:0] cur_iv_fu_150_p2;
wire   [127:0] grp_PRG_fu_96_ap_return_0;
wire   [127:0] grp_PRG_fu_96_ap_return_1;
reg    grp_PRG_fu_96_ap_ce;
reg    ap_block_state25_pp0_stage0_iter24_ignore_call6;
reg    ap_block_pp0_stage0_11001_ignoreCallOp44;
wire   [127:0] grp_PRG_fu_107_ap_return_0;
wire   [127:0] grp_PRG_fu_107_ap_return_1;
reg    grp_PRG_fu_107_ap_ce;
...
reg   [6:0] s_fu_60;
wire   [6:0] s_3_fu_132_p2;
wire    ap_loop_init;
reg   [6:0] ap_sig_allocacmp_s_2;
reg    ap_block_pp0_stage0_01001;
wire   [7:0] mul_fu_138_p3;
wire   [127:0] conv3_i12_i_i1_fu_146_p1;
reg    ap_done_reg;
...
GenerateProof_PRG grp_PRG_fu_96(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
GenerateProof_PRG grp_PRG_fu_107(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .iv_val(cur_iv_fu_150_p2),
    .seed(sd_load_1),
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln24_fu_126_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001_ignoreCallOp45))) begin
        grp_PRG_fu_107_ap_ce = 1'b1;
    end else begin
        grp_PRG_fu_107_ap_ce = 1'b0;
    end
end

always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001_ignoreCallOp44))) begin
        grp_PRG_fu_96_ap_ce = 1'b1;
    end else begin
        grp_PRG_fu_96_ap_ce = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_11001_ignoreCallOp44 = ((ap_enable_reg_pp0_iter24 == 1'b1) & (1'b1 == ap_block_state25_pp0_stage0_iter24_ignore_call6));
end

always @ (*) begin
    ap_block_pp0_stage0_11001_ignoreCallOp45 = ((ap_enable_reg_pp0_iter24 == 1'b1) & (1'b1 == ap_block_state25_pp0_stage0_iter24_ignore_call11));
end
...
always @ (*) begin
    ap_block_state25_pp0_stage0_iter24 = ((r_strm_1_full_n == 1'b0) | (r_strm_0_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state25_pp0_stage0_iter24_ignore_call11 = ((r_strm_1_full_n == 1'b0) | (r_strm_0_full_n == 1'b0));
end

always @ (*) begin
    ap_block_state25_pp0_stage0_iter24_ignore_call6 = ((r_strm_1_full_n == 1'b0) | (r_strm_0_full_n == 1'b0));
end
...
assign conv3_i12_i_i1_fu_146_p1 = mul_fu_138_p3;

assign cur_iv_fu_150_p2 = (conv3_i12_i_i1_fu_146_p1 + iv_val);

assign icmp_ln24_fu_126_p2 = ((ap_sig_allocacmp_s_2 == 7'd93) ? 1'b1 : 1'b0);

assign mul_fu_138_p3 = {{ap_sig_allocacmp_s_2}, {1'd0}};

assign r_strm_0_din = {{grp_PRG_fu_96_ap_return_1}, {grp_PRG_fu_96_ap_return_0}};

assign r_strm_1_din = {{grp_PRG_fu_107_ap_return_1}, {grp_PRG_fu_107_ap_return_0}};

assign s_3_fu_132_p2 = (ap_sig_allocacmp_s_2 + 7'd1);
