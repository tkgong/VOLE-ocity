...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { proof_strm_TREADY { I 1 bit } proof_strm_TDATA { O 128 vector } proof_strm_TVALID { O 1 bit } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { path_strm_dout { I 128 vector } path_strm_empty_n { I 1 bit } path_strm_read { O 1 bit } } \
} "
}
