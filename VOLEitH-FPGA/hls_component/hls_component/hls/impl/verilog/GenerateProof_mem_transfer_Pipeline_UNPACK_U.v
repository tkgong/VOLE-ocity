...
wire   [0:0] icmp_ln106_1_fu_211_p2;
reg   [8:0] b_fu_68;
wire   [8:0] add_ln103_fu_226_p2;
wire    ap_loop_init;
reg   [8:0] ap_sig_allocacmp_b_2;
reg    u_0_we1_local;
wire   [0:0] tmp_415_fu_184_p3;
reg    u_0_ce1_local;
reg    u_1_we1_local;
wire   [0:0] tmp_416_fu_217_p3;
reg    u_1_ce1_local;
wire   [15:0] zext_ln103_fu_140_p1;
wire   [6:0] lshr_ln_fu_154_p4;
wire   [14:0] or_ln_fu_164_p3;
wire   [15:0] add_ln105_fu_148_p2;
wire   [7:0] tmp_415_fu_184_p2;
wire   [15:0] or_ln1_fu_201_p4;
wire   [7:0] tmp_416_fu_217_p2;
reg    ap_done_reg;
...
wire    ap_ready_sig;
wire    ap_done_sig;
wire   [0:0] tmp_415_fu_184_p0;
wire   [0:0] tmp_416_fu_217_p0;
wire    ap_ce_reg;
...
GenerateProof_bitselect_1ns_256ns_8ns_1_1_1 #(
    .DATAWIDTH( 256 ),
    .ADDRWIDTH( 8 ))
bitselect_1ns_256ns_8ns_1_1_1_U953(
    .din(u_t),
...
GenerateProof_bitselect_1ns_256ns_8ns_1_1_1 #(
    .DATAWIDTH( 256 ),
    .ADDRWIDTH( 8 ))
bitselect_1ns_256ns_8ns_1_1_1_U954(
    .din(u_t),
...
always @ (*) begin
    if (((icmp_ln106_1_fu_211_p2 == 1'd1) & (tmp_fu_132_p3 == 1'd0) & (1'b0 == ap_block_state1_pp0_stage0_iter0) & (1'b1 == ap_CS_fsm_state1))) begin
        u_1_we1_local = 1'b1;
    end else begin
        u_1_we1_local = 1'b0;
    end
...
assign add_ln103_fu_226_p2 = (ap_sig_allocacmp_b_2 + 9'd2);

assign add_ln105_fu_148_p2 = (tmp_165 + zext_ln103_fu_140_p1);
...
assign icmp_ln106_1_fu_211_p2 = ((or_ln1_fu_201_p4 < 16'd40273) ? 1'b1 : 1'b0);

assign icmp_ln106_fu_178_p2 = ((add_ln105_fu_148_p2 < 16'd40273) ? 1'b1 : 1'b0);

assign lshr_ln_fu_154_p4 = {{ap_sig_allocacmp_b_2[7:1]}};

assign or_ln1_fu_201_p4 = {{{s}, {lshr_ln_fu_154_p4}}, {1'd1}};

assign or_ln_fu_164_p3 = {{s}, {lshr_ln_fu_154_p4}};

assign tmp_415_fu_184_p2 = ap_sig_allocacmp_b_2[7:0];

assign tmp_416_fu_217_p2 = {{lshr_ln_fu_154_p4}, {1'd1}};
...
assign u_0_d1 = tmp_415_fu_184_p3;
...
assign u_1_d1 = tmp_416_fu_217_p3;
