...
entity GenerateProof_EvalCircuit_extended_witness_RAM_1WNR_AUTO_1R1W is 
    generic(
        MEM_TYPE        : string    := "auto"; 
        DataWidth       : integer   := 1; 
        AddressWidth    : integer   := 19;
        AddressRange    : integer   := 386045
    ); 
    port (
...
architecture rtl of GenerateProof_EvalCircuit_extended_witness_RAM_1WNR_AUTO_1R1W is 
